...
class TestGetTxAmountColorClass:
    ...
    def test_transfer_positive_delta_returns_green(self) -> None:
        """Transfer with positive balance_delta (deposited) shows green."""
    ...
    def test_transfer_zero_delta_returns_green(self) -> None:
        """Transfer with zero balance_delta returns green (default)."""
        result = get_tx_amount_color_class("transfer", Decimal("0.00"))
        assert result == "text-green-600"

    def test_transfer_no_delta_returns_green(self) -> None:
        """Transfer without balance_delta defaults to green."""
        result = get_tx_amount_color_class("transfer", None)
        assert result == "text-green-600"

    def test_exchange_positive_delta_returns_green(self) -> None:
        """Exchange with positive delta shows green."""
    ...
    def test_unknown_type_positive_delta_returns_green(self) -> None:
        """Unknown type with positive delta returns green."""
