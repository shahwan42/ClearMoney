...
urlpatterns = [
    ...
    # --- HTMX Partials ---
    path("transactions/list", views.transactions_list_partial, name="transaction-list-partial"),
    ...
    # --- Mutation Views ---
    path("transactions/transfer", views.transfer_create, name="transaction-transfer-create"),
    path("transactions/exchange-submit", views.exchange_create, name="transaction-exchange-create"),
    ...
    # --- JSON API ---
    path("api/transactions", views.api_transaction_list_create, name="api-transaction-list-create"),
