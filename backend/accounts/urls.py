...
urlpatterns = [
    ...
    path("accounts/institution-form", views.institution_form_partial, name="institution-form"),
    ...
    path("accounts/<uuid:id>/statement", views.credit_card_statement, name="cc-statement"),
    path("accounts/<uuid:id>/edit-form", views.account_edit_form, name="account-edit-form"),
    ...
    path("institutions/reorder", views.institutions_reorder, name="institutions-reorder"),
    path("institutions/<uuid:id>/edit-form", views.institution_edit_form, name="institution-edit-form"),
