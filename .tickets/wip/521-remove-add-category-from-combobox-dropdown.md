...
- [ ] Combobox dropdown no longer shows "+ Add new category" at bottom
- [ ] Inline `+` button beside combobox still opens new-category bottom sheet
- [ ] `category:created` event still auto-selects newly created category in combobox
- [ ] J-2 walkthrough passes
