...
- [ ] The inline "New Budget" form is replaced by a clear trigger that opens a bottom sheet
- [ ] The budget create form renders inside a bottom sheet using the existing shared sheet pattern
- [ ] All current create-budget fields and validation behavior remain available in the bottom sheet
- [ ] Successful budget creation preserves the current post-submit behavior and updates the budgets UI correctly
- [ ] The "Copy last month" action remains available in an appropriate location on the budgets page
- [ ] Mobile and keyboard interaction for the new sheet flow are covered by tests or existing tests are updated
- [ ] Budgets page documentation is updated if it still describes the create form as inline
