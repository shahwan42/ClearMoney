...
- [ ] New accounts (0 transactions, or created < 30 days ago) do not show the "never been reconciled" banner
- [ ] Existing accounts with transaction history continue to show the banner as before
- [ ] The banners are still dismissible (×) as currently implemented
