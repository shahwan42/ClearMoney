...
- [ ] Confirm none of these fields are read/written anywhere in services, views, or templates
- [ ] If dead: create migration to drop the columns (multi-step: check prod data first)
