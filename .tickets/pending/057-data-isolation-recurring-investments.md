...
- [ ] Add `test_recurring_rules_isolated` — User B cannot see User A's recurring rules
- [ ] Add `test_recurring_rule_by_id_isolated` — User B cannot fetch User A's rule by ID
- [ ] Add `test_investments_isolated` — User B cannot see User A's investments
- [ ] Add `test_investment_by_id_isolated` — User B cannot fetch User A's investment by ID
