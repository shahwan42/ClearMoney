...
- [x] Notifications marked as read stay read across app restarts
- [x] New notifications (new tag) still appear as unread
- [x] Existing tests pass; new test covers preserve-read-on-update
