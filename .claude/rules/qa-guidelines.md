...
> `.claude/rules/tdd-workflow.md` (RED→GREEN), `.claude/rules/delivery-checklist.md` (gates),
> `.claude/rules/accessibility-qa-protocol.md` (WCAG), `.claude/rules/batch-execution-pattern.md` (batch work),
