...
| **[BACKEND_ARCHITECTURE.md](BACKEND_ARCHITECTURE.md)** | Django backend: 14 models, 13 apps, service layer, patterns, middleware, testing, deployment | Backend developers, architects |
| **[ROUTES.md](ROUTES.md)** | Complete route inventory: 106+ routes, HTTP methods, query params, request/response examples | Backend developers, API consumers |
...
- **Backend**: 13 Django apps, 14 models, 106+ routes
- **Testing**: 692+ unit/integration tests, 16 Playwright e2e specs
